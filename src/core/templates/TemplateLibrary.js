        ...
        return [
            {
                ...
                body: 'This tool provides legal information, not legal advice. Verify applicability for your jurisdiction. Consult a lawyer or licensed paralegal for advice. Confirm all outputs against current law and your facts.'
            },
            {
                title: 'Source Access Disclaimer',
                body: 'Use only official APIs or official links (e.g., CanLII, e-Laws, Justice Laws). Include URLs and retrieval/currency dates. Do not scrape or copy restricted content.'
            }
        ];
    }
    packageLayout() {
