...
export class CriminalDomainModule extends BaseDomainModule {
    domain = 'criminal';
    name = 'Criminal (Info-Only) Module';
    tags = [
        'Assault offences',
        'Uttering threats',
        'Criminal charges',
     ...
     */
    async generateDocuments(classification, _forumMap, _timelineEvents, evidenceManifest, _journeyMap) {
        const drafts = [];
        const manifests = [];
...
//# sourceMappingURL=CriminalDomainModule.js.map