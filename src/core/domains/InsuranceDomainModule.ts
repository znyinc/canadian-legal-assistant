...
export class InsuranceDomainModule extends BaseDomainModule {
  ...
  protected buildDrafts(input: DomainModuleInput): DocumentDraft[] {
    ...
    const mkDraft = (title: string, summary: string, customSections?: any[]): DocumentDraft => {
  ...
  private buildMotorVehicleDocuments(input: DomainModuleInput, mkDraft: Function, refs: any[]): DocumentDraft[] {
    ...
    docs.push(mkDraft(
      'Accident Report / Statement of Facts',
      'Detailed statement of the motor vehicle accident for insurance, police, or Collision Reporting Centre.',
      [
        {
    ...
    if (isOntario) {
      docs.push(mkDraft(
        'Direct Compensation Property Damage (DC-PD) Claim Letter',
        'Claim letter to your own insurer for property damage under Ontario\'s no-fault system.',
        [
          {
      ...
      docs.push(mkDraft(
        ...
        'Letter to insurance company reporting accident and claiming property damage.',
        [
          {
    ...
    docs.push(mkDraft(
      'Demand Letter for Out-of-Pocket Expenses',
      'Letter to at-fault party demanding reimbursement for expenses not covered by insurance.',
      [
        {
    ...
    docs.push(mkDraft(
      'Small Claims Court - Statement of Claim',
      'Formal claim for damages in Small Claims Court (for amounts under jurisdiction limit).',
      [
        {
    ...
    // 5. Incident Timeline
    docs.push(mkDraft(
      'Incident Timeline for Insurance Adjuster',
      'Chronological timeline of events for insurance claim processing.',
      [
        {
