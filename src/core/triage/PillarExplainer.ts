import { Pillar } from './PillarClassifier';

export class PillarExplainer {
  explain(pillar: Pillar, domain?: string) {
    // Domain-specific nextSteps augmentation
    const domainNextSteps = (base: string[], domain?: string) => {
    ...
    switch (pillar) {
      case 'Criminal':
        return {
          ...
          overview:
            'Criminal matters involve allegations of offences against public law brought by the state. If you are a victim of a crime, contact police; this tool provides information, not legal advice.',
      ...
      case 'Civil':
        return {
          ...
          overview:
            'Civil matters involve disputes between private parties, such as negligence or property damage. Civil claims focus on remedies like damages or specific performance.',
      ...
      case 'Administrative':
        return {
          ...
          overview:
            'Administrative matters typically go to tribunals or regulatory bodies (e.g., LTB, HRTO). Procedures and remedies differ from courts.',
      ...
      case 'Quasi-Criminal':
        return {
          ...
          overview:
            'Quasi-criminal matters include regulatory offences and by-law violations. These can have penalties but follow administrative/enforcement pathways.',
