...
export class IntegrationAPI {
  ...
  async executeKit(req: KitExecutionRequest): Promise<KitExecutionResponse> {
    ...
    const result: KitWorkflowResult = req.trackStages
      ? await this.kitOrchestrator.executeKitWithTracking(sessionId, kit, req.intake)
      : await this.kitOrchestrator.executeKit(sessionId, kit, req.intake);
